...
public class MyStocksWidgetService extends RemoteViewsService {
    @Override
    public RemoteViewsFactory onGetViewFactory(Intent intent) {
        return new MyStocksRemoteViewsFactory(MyStocksWidgetService.this);
    }
}

class MyStocksRemoteViewsFactory implements RemoteViewsService.RemoteViewsFactory {
    private Context mContext;
    private Cursor mCursor;

    public MyStocksRemoteViewsFactory(Context context) {
    ...
    public RemoteViews getViewAt(int position) {
        ...
        remoteView.setOnClickFillInIntent(R.id.list_item_parent, fillInIntent);
